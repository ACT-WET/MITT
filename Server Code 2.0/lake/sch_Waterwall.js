function wwSchWrapper(){
    ...
    var wwPumpSchData = wwPumpSch;
    var on_time = wwPumpSchData[(3*day_ID)+1];
    var off_time = wwPumpSchData[(3*day_ID)+2];
    ...
    if ((current_time >= on_time)&&(current_time < off_time)){
        //turn ON
        atalplc_client.writeSingleCoil(2111,1,function(resp){
        ...
        //turn OFF
        atalplc_client.writeSingleCoil(2111,0,function(resp){
