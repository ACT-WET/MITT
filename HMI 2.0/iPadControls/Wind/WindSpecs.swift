...
let WIND_SPEED_MEASURE_UNIT_2_UI_TAG    = 113
...
public struct  WIND_SENSOR_1 {
    ...
    let SPEED_MED_SET_POINT =       (register:804, type:"REAL",  name: "ST1001_Speed_Med_S")
    let SPEED_HIGH_SET_POINT =      (register:806, type:"REAL",  name: "ST1001_Speed_Hi_SP")
    let SPEED_ABORT_SET_POINT =     (register:808, type:"REAL",  name: "ST1001_Speed_Abort_SP")
    let DIRECTION_SCALED_VALUE =    (register:810, type:"REAL",  name: "ST1001_Drctn_Scaled_Value")
    ...
    let DIRECTION_CHANNEL_FAULT =   (register:806, type:"EBOOL", name: "ST1001_Drctn_Channel_Fault")
...
public struct  WIND_SENSOR_2 {
    ...
    let SPEED_SCALED_VALUE =        (register:820, type:"REAL",  name: "ST1002_Speed_Scaled_Value")
    let SPEED_LOW_SET_POINT =       (register:822, type:"REAL",  name: "ST1002_Speed_Lo_S")
    let SPEED_MED_SET_POINT =       (register:824, type:"REAL",  name: "ST1002_Speed_Med_S")
    let SPEED_HIGH_SET_POINT =      (register:826, type:"REAL",  name: "ST1002_Speed_Hi_SP")
    let SPEED_ABORT_SET_POINT =     (register:828, type:"REAL",  name: "ST1002_Speed_Abort_SP")
    let DIRECTION_SCALED_VALUE =    (register:830, type:"REAL",  name: "ST1002_Drctn_Scaled_Value")
    let SPEED_ABORT_SHOW =          (register:820, type:"EBOOL", name: "ST1002_Speed_Abort_Show")
    let SPEED_ABOVE_HIGH =          (register:821, type:"EBOOL", name: "ST1002_Speed_Above_Hi")
    let SPEED_ABOVE_MED =           (register:822, type:"EBOOL", name: "ST1002_Speed_Above_Med")
    let SPEED_BELOW_LOW =           (register:823, type:"EBOOL", name: "ST1002_Speed_Below_Low")
    let SPEED_NOWIND =              (register:824, type:"EBOOL", name: "ST1002_speed_NoWind")
    let SPEED_CHANNEL_FAULT =       (register:825, type:"EBOOL", name: "ST1002_Speed_Channel_Fault")
    let DIRECTION_CHANNEL_FAULT =   (register:826, type:"EBOOL", name: "ST1002_Drctn_Channel_Fault")
