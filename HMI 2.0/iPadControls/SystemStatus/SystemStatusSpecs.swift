...
let ETHERNET_STATUS = (startingregister: 221, count: 7)
let STRAINER_STATUS = (startingregister: 4500, count: 7)

let GLIM_ETHERNET_STATUS = (startingregister: 221, count: 5)
let GLIM_STRAINER_STATUS = (startingregister: 4500, count: 4)

let ALIGHT_ETHERNET_STATUS = (startingregister: 221, count: 11)
let ALIGHT_STRAINER_STATUS = (startingregister: 4500, count: 7)

let DELUGE_ETHERNET_STATUS = (startingregister: 221, count: 4)
let DELUGE_STRAINER_STATUS = (startingregister: 4500, count: 3)
...
let ALIGHT_SYSTEM_YELLOW_STATUS = [
    (tag: 1, bitwiseLocation: 0, type:"INT", name: "Clean Strainer"),
    (tag: 2, bitwiseLocation: 1, type:"INT", name: "Br Timeout"),
    (tag: 3, bitwiseLocation: 2, type:"INT", name: "Water Makeup Timeout"),
    (tag: 4, bitwiseLocation: 3, type:"INT", name: "WQ warning")
...
let DELUGE_SYSTEM_YELLOW_STATUS = [
    (tag: 1, bitwiseLocation: 0, type:"INT", name: "Clean Strainer"),
    (tag: 2, bitwiseLocation: 1, type:"INT", name: "Br Timeout"),
    (tag: 3, bitwiseLocation: 2, type:"INT", name: "Water Makeup Timeout"),
    (tag: 4, bitwiseLocation: 3, type:"INT", name: "WQ warning")
