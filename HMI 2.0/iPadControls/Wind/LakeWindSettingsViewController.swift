//
//  GlimmerWindSettingsViewController.swift
//  iPadControls
//
...
class LakeWindSettingsViewController: UIViewController {
    ...
    private func loadCurrentSetpointsFromPLC(){
        ...
        CENTRAL_SYSTEM!.readRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, length: 6, startingRegister: Int32(WIND_TIMER_PLC_ADDRESSES), completion:{ (success, response) in
    ...
    private func saveSetpointsToPLC(){
        ...
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+4, value: lowOn!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+5, value: lowOff!)
