//
//  LakewindSettingsViewController.swift
//  iPadControls
//
...
class LakewindSettingsViewController: UIViewController {
    ...
    private func loadCurrentSetpointsFromPLC(){
        ...
        CENTRAL_SYSTEM?.readRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, length: 8, startingRegister: Int32(WIND_TIMER_PLC_ADDRESSES), completion:{ (success, response) in
    ...
    private func saveSetpointsToPLC(){
        ...
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES, value: abortOn!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+1, value: abortOff!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+2, value: highOn!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+3, value: highOff!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+4, value: medOn!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+5, value: medOff!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+6, value: lowOn!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: WIND_TIMER_PLC_ADDRESSES+7, value: lowOff!)
