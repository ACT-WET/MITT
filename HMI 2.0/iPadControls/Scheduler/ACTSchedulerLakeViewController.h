//
//  ACTSchedulerLakeViewController.h
//  iPadControls
//
...
@interface ACTSchedulerLakeViewController : UIViewController <UIScrollViewDelegate, UIPopoverControllerDelegate, UIAlertViewDelegate, ACTUISafeNavigationDelegate>
