...
//        }
    ...
    func loadplcSetpoints(){
        ...
        CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LAG_PLC_IP_ADDRESS, register: MAX_FREQUENCY_SP, value:Float(maxFreq))
        CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LAG_PLC_IP_ADDRESS, register: MAX_TEMPERATURE_SP, value:Float(maxTemp))
        CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LAG_PLC_IP_ADDRESS, register: MID_TEMPERATURE_SP, value:Float(midTemp))
        CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LAG_PLC_IP_ADDRESS, register: MAX_VOLTAGE_SP, value: Float(maxVltg))
        CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LAG_PLC_IP_ADDRESS, register: MIN_VOLTAGE_SP, value:Float(minVltg))
        CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LAG_PLC_IP_ADDRESS, register: MAX_CURRENT_SP, value: Float(maxCurrent))
    }
    ...
    func setupUILabelData(){
        ...
        navigationItem.title = "MITT - LAGOON FEATURE"
    ...
    @IBAction func pushToStoryboard(_ sender: UIButton){
        ...
        if screenName != "" &&  screenName != "operationManual" && screenName != "WQMultiple"{
            ...
            if screenName == "lights" {
                ...
                readServerPath = GET_FILLER_SHOWSCH_STATE_HTTP_PATH
                writeServerPath = SET_FILLER_SHOWSCH_STATE_HTTP_PATH
                screen_Name = screenName
            }
