//
//  ACTAddShowPlaylistAlightViewController.m
//  iPadControls
//
...
@interface ACTAddShowPlaylistAlightViewController ()
...
@implementation ACTAddShowPlaylistAlightViewController
...
-(void)getCurrentScheduleAndButtonTag{
    ...
    _allPlaylists = [[NSMutableArray alloc] initWithArray:[_defaults objectForKey:@"alplaylists"]];
    _shows = [[NSMutableArray alloc] initWithArray:[_defaults objectForKey:@"alshows"]];
    
    //Get button tag from user defaults
    _buttonTag = [[_defaults objectForKey:@"albuttonTag"] intValue];
...
-(void)saveSchedule{
    ...
    [_defaults setObject:[NSNumber numberWithInt: (int)1] forKey:@"aldismiss"];
