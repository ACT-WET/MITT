//
//  ACTPlaylistSettingsAlightViewController.m
//  iPadControls
//
...
#import "ACTPlaylistSettingsAlightViewController.h"
#import "AFHTTPRequestOperationManager.h"
#import "ACTDesignateTestShowViewController.h"
#import "iPadControls-Swift.h"

@interface ACTPlaylistSettingsAlightViewController ()
...
@implementation ACTPlaylistSettingsAlightViewController{
...
-(IBAction)showScanner:(id)sender{
    ...
    [defaults setObject:@"1" forKey:@"alscanningShows"];
...
-(void)countDOwnTime{
    [self checkAlScanStatus];
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    NSString *ip = [defaults objectForKey:@"server2IpAddress"];
    NSString *pass = @"http://wet_act:A3139gg1121@";
    _scanState = [[defaults objectForKey:@"alscanningShows"] intValue];
    _currentScanShow = [[defaults objectForKey:@"alshowScanned"] intValue];
    _totalNumShows = [[defaults objectForKey:@"alnumberOfSPMShows"] intValue];
    _currentScanTestShow = [[defaults objectForKey:@"altestshowScanned"] intValue];
    _totalNumTestShows = [[defaults objectForKey:@"alnumberOfSPMTestShows"] intValue];
    if (_scanState == 1){
