//
//  ACTMoveDeleteShowPlaylistLakeViewController.m
//  iPadControls
//
...
@interface ACTMoveDeleteShowPlaylistLakeViewController ()
...
@implementation ACTMoveDeleteShowPlaylistLakeViewController
UIDatePicker *timPicker;
...
-(void)populatePopover:(int)tag{
    ...
    timPicker = [[UIDatePicker alloc] initWithFrame:CGRectMake(0, 140, 360, 250)];
    timPicker.datePickerMode = UIDatePickerModeTime;
    timPicker.hidden = NO;
    
    NSDate *today= timPicker.date;
    ...
    timPicker.date =  [gregorian dateFromComponents:components];
    [timPicker addTarget:self action:@selector(changeDateInLabel:) forControlEvents:UIControlEventValueChanged];
    [self.view addSubview:timPicker];
...
-(void)changeDateInLabel:(id)sender{
    ...
    _selectedTime =  [[NSString stringWithFormat:@"%@", [timeFormatter stringFromDate:timPicker.date]] intValue];
    
    timeFormatter.dateFormat = @"mm";
    
    _selectedTimeMin =  [[NSString stringWithFormat:@"%@", [timeFormatter stringFromDate:timPicker.date]] intValue];
