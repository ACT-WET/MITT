//
//  ACTSchedulerLakeViewController.m
//  iPadControls
//
...
#import "ACTSchedulerLakeViewController.h"
#import "AFHTTPRequestOperationManager.h"
#import "ACTMoveDeleteShowPlaylistLakeViewController.h"
#import "ACTAddShowPlaylistLakeViewController.h"
#import "ACTCalendarScheduleLakeViewController.h"
#import "iPadControls-Swift.h"

@interface ACTSchedulerLakeViewController ()
...
@implementation ACTSchedulerLakeViewController{
    
    ACTMoveDeleteShowPlaylistLakeViewController *controller;
    UIPopoverController *popoverMoveDeleteShowController;
    
    ACTAddShowPlaylistLakeViewController *controller2;
    UIPopoverController *popoverAddShowController;
    
    ACTCalendarScheduleLakeViewController *controller3;
...
-(void)checkForConnection{
    ...
    NSString *plcConnectionStatus   = [_defaults objectForKey:@"MITTLAPLCConnectionStatus"];
...
-(void)readPlaylistsAndShows{
    ...
    [manager GET:fullpath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject){
        ...
        [defaults setObject:_allPlaylists forKey:@"lakeplaylists"];
        ...
        [manager GET:fullpath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject){
            ...
            _currentSchedule = [defaults integerForKey:@"lakeCurrentSchedule"];
...
-(IBAction)clearWeekPushed:(UIButton *)sender{
    ...
    [_defaults setObject:_schedule forKey:@"lakeschedule"];
...
-(void)readJSONFile:(int)num{
    ...
    [manager GET:fullpath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject){
        ...
        [_defaults setObject:_allDays forKey:@"lakeschedule"];
...
-(void)moveDeleteShowPlaylist:(UIButton *)button{
    ...
    [_defaults setObject:[NSNumber numberWithInt: (int)button.tag] forKey:@"lakebuttonTag"];
    [_defaults setObject:[NSNumber numberWithInt: (int)0] forKey:@"lakedismiss"];

    controller = [[ACTMoveDeleteShowPlaylistLakeViewController alloc] init];
...
-(IBAction)addShowPlaylist:(UIButton *)sender{
    ...
    [_defaults setObject:[NSNumber numberWithInt: (int)sender.tag] forKey:@"lakebuttonTag"];
    [_defaults setObject:[NSNumber numberWithInt: (int)0] forKey:@"lakedismiss"];
    
    controller2 = [[ACTAddShowPlaylistLakeViewController alloc] init];
...
-(void)dismissPopoverView{
    ...
    int dismiss =[[_defaults objectForKey:@"lakedismiss"] intValue];
    ...
    if (dismiss){
        ...
        [_defaults setObject:[NSNumber numberWithInt: (int)0]  forKey:@"lakedismiss"];
        _schedule = [[NSMutableArray alloc]initWithArray:[_defaults objectForKey:@"lakeschedule"]];
...
-(IBAction)openCalendarSchedule:(UIButton *)sender{
    ...
    controller3 = [[ACTCalendarScheduleLakeViewController alloc] init];
