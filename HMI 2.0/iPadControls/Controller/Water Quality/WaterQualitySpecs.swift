...
let LAKE_WQ1_LIVE_SERVER_PATH      = "\(HTTP_PASS)\(SERVER_IP_ADDRESS):8080/SWQ1_Live"
let GLIMMER_WQ1_LIVE_SERVER_PATH      = "\(HTTP_PASS)\(SERVER_IP_ADDRESS):8080/GWQ1_Live"
let ALIGHT_WQ1_LIVE_SERVER_PATH      = "\(HTTP_PASS)\(SERVER_IP2_ADDRESS):8080/WQ1_Live"
let DELUGE_WQ1_LIVE_SERVER_PATH      = "\(HTTP_PASS)\(SERVER_IP2_ADDRESS):8080/DWQ1_Live"
