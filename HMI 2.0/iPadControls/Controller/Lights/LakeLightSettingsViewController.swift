//
//  LakeLightSettingsViewController.swift
//  iPadControls
//
...
class LakeLightSettingsViewController: UIViewController {
   //Timer Delay SP
    ...
    private func saveTimerSetpointDelaysToPLC(){
        ...
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: LAKE_WATER_LEVEL_ABOVE_H_DELAY_TIMER, value: aboveHiSPDelay!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: LAKE_WATER_LEVEL_BELOW_L_TIMER, value: belowLDelay!)
        CENTRAL_SYSTEM?.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: LAKE_WATER_LEVEL_BELOW_LL_TIMER, value: belowLLDelay!)
    ...
    private func readTimersFromPLC(){
            ...
            CENTRAL_SYSTEM?.readRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, length: Int32(LAKE_WATER_LEVEL_TIMER_BITS.count), startingRegister: Int32(LAKE_WATER_LEVEL_TIMER_BITS.startBit),  completion: { (success, response) in
