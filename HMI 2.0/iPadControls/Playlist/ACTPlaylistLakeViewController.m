//
//  ACTPlaylistLakeViewController.m
//  iPadControls
//
...
@interface ACTPlaylistLakeViewController () <UITextFieldDelegate> {
...
@implementation ACTPlaylistLakeViewController{
    ACTSelectShowLakeViewController *controller;
...
-(void)checkAutoHandMode{
    ...
    if (_state == 0){
        ...
        int playMode = [[defaults objectForKey:@"lakeplayStatus"] intValue];
...
-(void)openPopupShowSelector{
    ...
    controller = [[ACTSelectShowLakeViewController alloc] init];
...
-(void)dismissPopoverView{
    ...
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    int dismiss = [[defaults objectForKey:@"lakedismiss"] intValue];
    ...
    if (dismiss){
        ...
        [defaults setObject:0 forKey:@"lakedismiss"];

        selectedShow = [[defaults objectForKey:@"lakeselectedShow"] intValue];
        _loopCount = [[defaults objectForKey:@"lakeloopCount"] intValue];
    ...
    if (cellIndex < _rowCount){
        ...
        if ([newShowName length]){
            ...
            if (![newShowName isEqualToString:_textfieldText]){
                ...
                NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
                [defaults setObject:_shows forKey:@"lakeshows"];
...
-(void)getCurrentShowInformation{
    ...
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    NSString *showScannerOn = [defaults objectForKey:@"lakescanningShows"];
    
    if ([showScannerOn isEqualToString:@"0"]){
        
        int currentShowNumber = [[defaults objectForKey:@"lakecurrentShowNumber"] intValue];
