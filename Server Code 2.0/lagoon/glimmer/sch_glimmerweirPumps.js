function pumpSchWrapper(){
    ...
    var pumpSchData = glimweirPumpSch;
    var on_time = pumpSchData[(3*day_ID)+1];
    var off_time = pumpSchData[(3*day_ID)+2];
    ...
    if ((current_time >= on_time)&&(current_time < off_time)){
        //turn ON
        atglplc_client.writeSingleCoil(2114,1,function(resp){
        ...
        //turn OFF
        atglplc_client.writeSingleCoil(2114,0,function(resp){
