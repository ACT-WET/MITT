function weirSchWrapper(){
    ...
    if ((current_time >= on_time)&&(current_time < off_time)){
        //turn ON
        atalplc_client.writeSingleCoil(2114,1,function(resp){
        ...
        //turn OFF
        atalplc_client.writeSingleCoil(2114,0,function(resp){
