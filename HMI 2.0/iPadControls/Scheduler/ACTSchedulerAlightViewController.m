//
//  ACTSchedulerAlightViewController.m
//  iPadControls
//
...
#import "ACTSchedulerAlightViewController.h"
#import "AFHTTPRequestOperationManager.h"
#import "ACTMoveDeleteShowPlaylistAlightViewController.h"
#import "ACTAddShowPlaylistAlightViewController.h"
#import "ACTCalendarScheduleAlightViewController.h"
#import "iPadControls-Swift.h"

@interface ACTSchedulerAlightViewController ()
...
@implementation ACTSchedulerAlightViewController{
    
    ACTMoveDeleteShowPlaylistAlightViewController *controller;
    UIPopoverController *popoverMoveDeleteShowController;
    
    ACTAddShowPlaylistAlightViewController *controller2;
    UIPopoverController *popoverAddShowController;
    
    ACTCalendarScheduleAlightViewController *controller3;
...
-(void)checkForConnection{
    ...
    NSString *serverConnectionStatus = [_defaults objectForKey:@"Server2ConnectionStatus"];
    NSString *plcConnectionStatus   = [_defaults objectForKey:@"ATALPLCConnectionStatus"];
...
-(void)initializeFile{
    ...
    _ip = [_defaults objectForKey:@"server2IpAddress"];
...
-(void)readPlaylistsAndShows{
    ...
    [manager GET:fullpath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject){
        ...
        [defaults setObject:_allPlaylists forKey:@"alplaylists"];
        ...
        [manager GET:fullpath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject){
            ...
            _currentSchedule = [defaults integerForKey:@"AlCurrentSchedule"];
...
-(IBAction)clearWeekPushed:(UIButton *)sender{
    ...
    [_defaults setObject:_schedule forKey:@"alschedule"];
...
-(void)readJSONFile:(int)num{
    ...
    [manager GET:fullpath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject){
        ...
        [_defaults setObject:_allDays forKey:@"alschedule"];
...
-(void)moveDeleteShowPlaylist:(UIButton *)button{
    ...
    [_defaults setObject:[NSNumber numberWithInt: (int)button.tag] forKey:@"albuttonTag"];
    [_defaults setObject:[NSNumber numberWithInt: (int)0] forKey:@"aldismiss"];

    controller = [[ACTMoveDeleteShowPlaylistAlightViewController alloc] init];
...
-(IBAction)addShowPlaylist:(UIButton *)sender{
    ...
    [_defaults setObject:[NSNumber numberWithInt: (int)sender.tag] forKey:@"albuttonTag"];
    [_defaults setObject:[NSNumber numberWithInt: (int)0] forKey:@"aldismiss"];
    
    controller2 = [[ACTAddShowPlaylistAlightViewController alloc] init];
...
-(void)dismissPopoverView{
    ...
    int dismiss =[[_defaults objectForKey:@"aldismiss"] intValue];
    ...
    if (dismiss){
        ...
        [_defaults setObject:[NSNumber numberWithInt: (int)0]  forKey:@"aldismiss"];
        _schedule = [[NSMutableArray alloc]initWithArray:[_defaults objectForKey:@"alschedule"]];
...
-(IBAction)openCalendarSchedule:(UIButton *)sender{
    ...
    controller3 = [[ACTCalendarScheduleAlightViewController alloc] init];
