//
//  LakeFiltrationSettingsViewController.swift
//  iPadControls
//
...
class LakeFiltrationSettingsViewController: UIViewController,UITextFieldDelegate {
    ...
    private func getCurrentSetpoints(){
       ...
       self.midTemperature.text = "\(midTemp)"
        ...
        CENTRAL_SYSTEM?.readRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, length: 1, startingRegister: Int32(PRESSURE_DELAYTIMER), completion:{ (success, response) in
        ...
        CENTRAL_SYSTEM?.readRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, length: 3, startingRegister: Int32(LAKE_PDSH_DELAYTIMER), completion:{ (success, response) in
    ...
    @objc private func savePumpSettings(){
          ...
          CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: MAX_FREQUENCY_SP, value: maxFrequency!)
          CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: MAX_TEMPERATURE_SP, value: maxTemperature!)
          CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: MID_TEMPERATURE_SP, value: midTemperature!)
          CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: MAX_VOLTAGE_SP, value: maxVoltage!)
          CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: MIN_VOLTAGE_SP, value: minVoltage!)
          CENTRAL_SYSTEM!.writeRealValue(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: MAX_CURRENT_SP, value: maxCurrent!)
          ...
          CENTRAL_SYSTEM!.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: PRESSURE_DELAYTIMER, value: pressure!)
          CENTRAL_SYSTEM!.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: LAKE_PDSH_DELAYTIMER, value: pdsh!)
          CENTRAL_SYSTEM!.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: LAKE_PDSH_DELAYTIMER+1, value: bwDur!)
          CENTRAL_SYSTEM!.writeRegister(plcIpAddress: MITT_LA_PLC_IP_ADDRESS, register: LAKE_PDSH_DELAYTIMER+2, value: bwTrig!)
