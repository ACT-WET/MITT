//
//  ACTSelectShowAlightViewController.m
//  iPadControls
//
...
@interface ACTSelectShowAlightViewController ()
...
@property (nonatomic) ACTPlaylistAlightViewController *controller;
...
@implementation ACTSelectShowAlightViewController
...
-(void)readInternalShowFile{
    ...
    if ([defaults objectForKey:@"alshows"]){
        ...
        _shows = [[NSMutableArray alloc] initWithArray:[defaults objectForKey:@"alshows"]];
...
-(void)addShow{
    ...
    if(_selectedShow){
        ...
        NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
        [defaults setObject:[NSNumber numberWithInt: (int)_selectedShow] forKey:@"alselectedShow"];
        [defaults setObject:[NSNumber numberWithInt: (int)_loopCount] forKey:@"alloopCount"];
        [defaults setObject:[NSNumber numberWithInt: (int)1] forKey:@"aldismiss"];
