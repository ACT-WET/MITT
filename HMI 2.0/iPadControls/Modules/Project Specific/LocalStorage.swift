...
public class LocalStorage{
    ...
    private func saveDefaultNetworkData(){
        ...
        network.mittlagplcIpAddress = MITT_LAG_PLC_IP_ADDRESS
        network.mittlaplcIpAddress = MITT_LA_PLC_IP_ADDRESS
        network.serverIpAddress  = SERVER_IP_ADDRESS
        network.server2IpAddress = SERVER_IP2_ADDRESS
    ...
    private func saveDefaultPumpScreenParams(){
        ...
        pumpScreen.maxPumpFrequency  = 50
